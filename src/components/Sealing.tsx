    ...
    <section id="sealingSection">
      <div id="sealingInfo">
        ...
        <p className="barlow-regular">If you are able and willing to attend the sealing inside of the temple, 
          please show up early at 9:45am to wait in an area designated by temple workers.
        </p>
        <p className="barlow-regular">For those who will wait outside of the temple, you are welcome to explore temple 
          grounds in the meantime. There’s a rooftop garden on top of the temple accessible 
          to the public with a breathtaking view of the Bay Area, as well as the Visitors’ 
          Center with the Family History Center on the bottom floor.
        </p>
